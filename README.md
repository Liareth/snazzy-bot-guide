...
Once you've found an image you like, you may wish to create variations of that image. One good reason is to solve minor perfections in the generated image. To do this, you may use the `/img variations` command. This command requires the original file generated by `/img generate` including the same file name, as it encodes metadata about the original generation in the file name. You can provide a *closeness* value which determines how closely the generation will adhere to the original image.
